...
export function Card({
  ...
  return (
    <div
      className={cn(
        "rounded-3xl border border-border bg-surface shadow-[0_1px_3px_rgb(0_0_0/0.04)]",
        className
      )}
      {...props}
    />
    ...
    return (
      <input
        ...
        className={cn(
          ...
          "placeholder:text-muted focus:outline-2 focus:outline-offset-1 focus:outline-ring",
          className
        )}
        {...props}
      />
